...
class RecurrentUnitaryLayer(MergeLayer):
    """
    ...
    def __init__(self, incoming, input_to_hidden, hidden_to_hidden,
        ...
        super(RecurrentUnitaryLayer, self).__init__(incomings, **kwargs)
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        # When nonlinearity is a Layer, we need to pass its parameters (if they are)
        if isinstance(self.nonlinearity, Layer):
            non_seqs += helper.get_all_params(self.nonlinearity)
        ...
        def step(input_n, hid_previous, *args):
            ...
            if isinstance(self.nonlinearity, Layer):
                return helper.get_output(self.nonlinearity, hid_pre, **kwargs)
            else:
